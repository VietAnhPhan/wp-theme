...
function theme_enqueue_styles()
{
    ...
    wp_enqueue_script('theme-script', get_template_directory_uri() . '/assets/js/main.js', array('wp-api'), '1.0', true);
    wp_enqueue_script('js', get_template_directory_uri() . '/js/index.js', array(), '1.0', true);
}
