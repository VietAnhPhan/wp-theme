export default class Search {
    constructor() {
        ...
        this.searchButton = document.querySelectorAll(".header__search-button");
        // console.log(this.searchButton);
        this.closeSearchButton = document.querySelector(".search-overlay__icon-close");
        ...
        wp.api.loadPromise.done(function () {
            ...
            post.fetch().done(function (posts) {
                posts.forEach(function (post) {
                    ...
                    a.classList.add("text_white", "link", "search-overlay__result-link");
                    li.classList.add("search-overlay__result-item");
    ...
    openSearch() {
        this.searchBar.classList.add("search-overlay_active");
        this.navItems.classList.add("display-none");
        this.closeSearchButton.classList.add("overlay__background");
    }

    closeSearch() {
        this.searchBar.classList.remove("search-overlay_active");
